lostBulletin = _.template("<div class='col-md-1'></div><div class='col-md-4 bulletin'><h3></h3> <%=animal_breed %><br><%= animal_gender%><br>Lost at: <%= where_lost %></div><div class='col-md-1'></div>") //this is a template, call it to build bulletins
